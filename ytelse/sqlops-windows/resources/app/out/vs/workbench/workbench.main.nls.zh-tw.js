...
define("vs/workbench/workbench.main.nls.zh-tw", {
	...
	"vs/platform/theme/common/colorExtensionPoint": [
		...
		"高對比佈景主題的預設色彩。應為十六進位 (#RRGGBB[AA]) 的色彩值，或提供預設的可設定佈景主題色彩。",
		"\'configuration.colors\' 必須是陣列",
		"{0} 必須是十六進位 (#RRGGBB[AA] or #RGB[A]) 的色彩值，或是提供預設的可設定佈景主題色彩之識別碼。",
		"\'configuration.colors.id\' 必須定義且不得為空白",
		"\'configuration.colors.id\' 必須依照 word[.word]*",
		"\'configuration.colors.description\' 必須定義且不得為空白",
		"\'configuration.colors.defaults\' 必須定義，且必須包含 \'light\'、\'dark\' 及 \'highContrast\'",
	],
	...
	"vs/workbench/common/theme": [
		...
		"用以醒目提示使用中索引標籤的框線。索引標籤是編輯器在編輯器區域中的容器。同一個編輯器群組中的多個索引標籤可以同時開啟。可能會有多個編輯器群組。",
		"用以在非焦點群組中醒目提示使用中索引標籤的框線。索引標籤是編輯器在編輯器區域中的容器。同一個編輯器群組中的多個索引標籤可以同時開啟。可能會有多個編輯器群組。 ",
		...
		"當一個工作區被開啟時，狀態列的前景色彩。狀態列會顯示在視窗的底部。",
		"當未開啟任何資料夾時，狀態列的前景色彩。狀態列會顯示在視窗的底部。",
		"當一個工作區被開啟時，狀態列的背景色彩。狀態列會顯示在視窗的底部。",
		...
		"拖放提要欄位區段的意見回應色彩。色彩應具透明度，以便讓提要欄位區段穿透顯示。提要欄位是總管和搜尋等檢視用的容器。",
	...
	"vs/workbench/electron-browser/actions": [
		...
		"工作區",
		"檔案",
		"選取以開啟 (按住 Cmd 鍵以在新視窗中開啟)",
		"選取以開啟 (按住 Ctrl 鍵以在新視窗中開啟)",
		"從最近開啟的檔案中移除",
		"開啟最近使用的檔案...",
		"快速開啟最近使用的檔案...",
		"關閉通知訊息",
	...
	"vs/workbench/electron-browser/main.contribution": [
		...
		"在 Workbench 中控制字型鋸齒化的方法。- 預設: 子像素字型平滑處理。在大部分非 Retina 顯示器上會顯示出最銳利的文字- 已消除鋸齒: 相對於子像素，根據像素層級平滑字型。可讓字型整體顯得較細- 無: 停用字型平滑處理。文字會以鋸齒狀的銳邊顯示 ",
		...
		"控制在關閉最後一個編輯器時，是否也應關閉視窗。此設定僅適用於未顯示資料夾的視窗。",
		"只在全螢幕模式時隱藏功能表。",
		"一律顯示功能表，即使在全螢幕模式時亦然。",
	...
	"vs/workbench/parts/files/browser/files.contribution": [
		...
		"檔案與資料夾會依照名稱以字母順序排序。資料夾會顯示在檔案前。",
		"檔案與資料夾會依照名稱以字母順序排序。檔案與資料夾會交錯排列。",
		"檔案與資料夾會依照名稱以字母順序排序。檔案會顯示在資料夾前。",
		"檔案與資料夾會依照延伸模組以字母順序排序。資料夾會顯示在檔案前。",
	...
	"vs/workbench/parts/files/browser/saveErrorHandler": [
		...
		"在右方使用編輯器工具列中的動作來 **復原** 您的變更，或以您的變更 **覆寫** 磁碟上的內容",
	],
	...
	"vs/workbench/parts/tasks/electron-browser/jsonSchema_v2": [
		...
		"執行此工作時，一律顯示終端機。",
		"沒有與工作相關的問題比對器，且執行未發生錯誤時，才顯示終端機。",
		"執行此工作時，永不顯示終端機。",
	...
	"vs/workbench/parts/tasks/electron-browser/task.contribution": [
		...
		"工作 \'{0}\' 已在使用中，且處於背景模式中。請使用工作功能表的 [終止工作...] 將其終止。",
		"工作 \'{0}\' 已在使用中。請使用工作功能表的 [終止工作...] 將其終止。 ",
	...
	"vs/workbench/parts/tasks/node/taskConfiguration": [
		...
		"工作版本 2.0.0 不支援全域 OS 特定工作。請使用 OS 特定命令來轉換這些工作。受影響的工作為:\n{0}",
	],
	...
	"vs/workbench/parts/terminal/electron-browser/terminal.contribution": [
		...
		"OS X 上的終端機要使用之具有將新增至 VS Code 流程之環境變數的物件",
		"Linux 上的終端機要使用之具有將新增至 VS Code 流程之環境變數的物件",
		"Windows 上的終端機要使用之具有將新增至 VS Code 流程之環境變數的物件",
		"終端機",
		"終端機",
		"檢視",
	],
	...
	"vs/workbench/services/configuration/node/configuration": [
		...
		"組態屬性的描述。",
		"視窗特定組態，可在使用者或工作區設定中予以設定。",
		"資源特定設定，可在使用者、工作區或資料夾設定中予以設定。",
		"組態適用的範圍。可用的範圍為「視窗」和「資源」。",
		"如果已設定，\'configuration.type\' 必須設定為物件",
		"\'configuration.title\' 必須是字串",
		"依語言貢獻預設編輯器組態設定。",
		"\'configuration.properties\' 必須是物件",
		"要在工作區中載入之資料夾的清單。必須是檔案路徑，例如 `/root/folderA` 或 `./folderA` 即為會對工作區檔案位置解析的相關路徑。",
