...
define("vs/workbench/workbench.main.nls.es", {
	...
	"vs/platform/theme/common/colorExtensionPoint": [
		...
		"Los identificadores deben estar en la forma aa [.bb] *",
		"La descripción de los colores de los temas",
		...
		"El color predeterminado para los temas con constraste. Un valor de color en hexadecimal (#RRGGBB [AA]) o el identificador de un color para los temas que proporciona el valor predeterminado.",
		...
		"\'configuration.colors.id\' debe ser definida y no puede estar vacía",
		"\'configuration.colors.id\' debe seguir la palabra [.word]*",
		"\'configuration.colors.description\' debe ser definida y no puede estar vacía",
		"\'configuration.colors.defaults\' debe ser definida y contener \'light\', \'dark\' y \'highContrast\'",
	],
	...
	"vs/workbench/browser/actions/workspaceActions": [
		...
		"&&Seleccionar",
		"Seleccionar carpetas para el área de trabajo",
		"Quitar carpeta del área de trabajo",
		"Guardar área de trabajo como...",
		"Abra un área de trabajo antes de guardar.",
		"&&Guardar",
	...
	"vs/workbench/common/theme": [
		...
		"Borde para resaltar las fichas activas. Las fichas son los contenedores de los editores en el área de editores. Se pueden abrir varias fichas en un grupo de editores. Puede haber varios grupos de editores.",
		"Borde para resaltar las fichas activas en un grupo que no tiene el foco. Las fichas son los contenedores de los editores en el área de editores. Se pueden abrir varias fichas en un grupo de editores. Puede haber varios grupos de editores. ",
		...
		"Color de primer plano de la barra de estado cuando se abre un espacio de trabajo. La barra de estado se muestra en la parte inferior de la ventana.",
		...
		"Color de fondo de la barra de estado cuando se abre un espacio de trabajo. La barra de estado se muestra en la parte inferior de la ventana.",
		...
		"Color de arrastrar y colocar comentarios para las secciones de la barra lateral. El color debe tener transparencia para permitir que se vean las secciones de la barra lateral, que es el contenedor para vistas como la del explorador o la de búsqueda.",
		...
		"Color de borde de la barra de título. Tenga en cuenta que, actualmente, este color se admite solo en macOS.",
	...
	"vs/workbench/electron-browser/actions": [
		...
		"No hay ninguna área de trabajo abierta en esta instancia para cerrarla.",
		"Nueva ventana",
	...
	"vs/workbench/electron-browser/main.contribution": [
		...
		"Reabrir todas las carpetas. Las áreas de trabajo vacías no se restaurarán.",
	...
	"vs/workbench/parts/files/browser/fileActions.contribution": [
		...
		"Usar los cambios y sobrescribir el contenido del disco",
		"Descartar los cambios y volver al contenido del disco",
	],
	...
	"vs/workbench/parts/files/browser/files.contribution": [
		...
		"Los archivos y las carpetas se ordenan por nombre alfabéticamente. Las carpetas se muestran antes que los archivos.",
		"Los archivos y las carpetas se ordenan por nombre alfabéticamente. Los archivos se entrelazan con las carpetas.",
		"Los archivos y las carpetas se ordenan por nombre alfabéticamente. Los archivos se muestran antes que las carpetas.",
		"Los archivos y las carpetas se ordenan por extensión. Las carpetas se muestran antes que los archivos.",
		"Los archivos y las carpetas se ordenan por fecha de última modificación. Las carpetas se muestran antes que los archivos.",
	...
	"vs/workbench/parts/files/browser/saveErrorHandler": [
		...
		"Use las acciones de la barra de herramientas del editor situada a la derecha para **deshacer** los cambios o **sobrescribir** el contenido del disco con sus cambios",
	],
	...
	"vs/workbench/parts/files/browser/views/explorerViewer": [
		...
		"¿Quiere agregar las carpetas al área de trabajo?",
		"¿Quiere agregar la carpeta al área de trabajo?",
		"&&Agregar carpetas",
		"&&Agregar carpeta",
	...
	"vs/workbench/parts/preferences/browser/preferencesRenderers": [
		"Coloque aquí su configuración para sobrescribir la configuración predeterminada.",
		"No se puede escribir la configuración. Corrija los errores o advertencias del archivo y vuelva a intentarlo.",
		"Coloque aquí su configuración para sobrescribir la configuración de usuario.",
		"Coloque aquí su configuración de carpeta para sobrescribir la que se especifica en la configuración de área de trabajo.",
		...
		"Esta configuración no se puede aplicar ahora. Se aplicará al abrir esta carpeta directamente.",
	],
	...
	"vs/workbench/parts/relauncher/electron-browser/relauncher.contribution": [
		...
		"Reiniciar",
		"Este cambio de área de trabajo requiere recargar nuestro sistema de extensiones.",
		"Recargar",
	],
	...
	"vs/workbench/parts/scm/electron-browser/scmViewlet": [
		...
		"No hay controles de código fuente activos.",
		"Control de código fuente",
		"{0}: {1}",
	],
	...
	"vs/workbench/parts/search/browser/searchActions": [
		"Mostrar siguiente búsqueda de patrón include",
		"Mostrar búsqueda anterior de patrón include ",
		"Mostrar siguiente búsqueda de patrón exclude ",
		"Mostrar búsqueda anterior de patrón exclude ",
	...
	"vs/workbench/parts/search/browser/searchViewlet": [
		...
		"No se encontraron resultados. Revise la configuración de exclusiones y archivos omitidos - ",
		"Buscar de nuevo",
	...
	"vs/workbench/parts/search/common/queryBuilder": [
		"Ninguna carpeta en el espacio de trabajo tiene el nombre: {0}",
	],
	...
	"vs/workbench/parts/tasks/electron-browser/jsonSchema_v2": [
		...
		"Solo revela el terminal si no hay ningún buscador de coincidencias de problemas asociado con la tarea y se producen errores al ejecutarla.",
	...
	"vs/workbench/parts/tasks/electron-browser/task.contribution": [
		...
		"Tareas",
		"Para cambiar el motor de ejecución de tareas, es necesario recargar la ventana",
		...
		"No examinar nunca la salida de la tarea",
		...
		"La tarea \"{0}\" ya está activa en segundo plano. Para terminarla, use la opción \"Terminar tarea\" del menú Tareas.",
		"La tarea \"{0}\" ya está activa. Para terminarla, use la opción \"Terminar tarea\" del menú Tareas.",
		...
		"No hay ninguna tarea en ejecución.",
		"No hay ninguna tarea en ejecución.",
	...
	"vs/workbench/parts/tasks/node/taskConfiguration": [
		...
		"La versión de tarea 2.0.0 no admite tareas específicas de SO globales. Conviértalas en una tarea con un comando específico de SO. Estas son las tareas afectadas:\n{0}",
	],
	"vs/workbench/parts/terminal/browser/terminalQuickOpen": [
		"{0}, selector de terminal",
		"{0}, crear nueva terminal",
		"$(plus) crear nueva Terminal integrada",
		"No hay terminales coincidentes",
	...
	"vs/workbench/parts/terminal/electron-browser/terminalActions": [
		...
		"Terminar la instancia del terminal",
		"Copiar selección",
		"Seleccionar todo",
		...
		"Mostrar siguiente término de búsqueda",
		"Mostrar término de búsqueda anterior",
		"Terminal: Cambiar Terminal Activo",
	],
	...
	"vs/workbench/parts/update/electron-browser/update": [
		...
		"Descargar ahora",
		"No volver a mostrar",
		"Ya está disponible {0} para Windows de 64 bits.",
		"Más información",
	...
	"vs/workbench/services/configuration/node/configuration": [
		...
		"Configuración específica para ventanas, que se puede definir en la configuración de usuario o de área de trabajo.",
		"Configuración específica para recursos, que se puede definir en la configuración de usuario, de área de trabajo o de carpeta.",
		"Ámbito donde es aplicable la configuración. Los ámbitos disponibles son \"window\" y \"resource\".",
		...
		"Lista de carpetas que debe cargarse en el área de trabajo. Debe ser una ruta de acceso de archivo; por ejemplo, \"/raíz/carpetaA\" o \"./carpetaA\" para una ruta de acceso relativa que se resolverá respecto a la ubicación del archivo del área de trabajo.",
	...
	"vs/workbench/services/configuration/node/jsonEditingService": [
		...
		"No se puede escribir en el archivo porque se ha modificado. Guarde el archivo y vuelva a intentarlo.",
	],
	...
	"vs/workbench/services/extensions/electron-browser/extensionService": [
		...
		"Reiniciar el host de extensiones",
		"El host de extensiones finalizó inesperadamente.",
		"Se terminó el host de extensiones porque no respondía.",
	...
	"vs/workbench/services/themes/common/colorThemeSchema": [
		...
		"Estilo de fuente debe ser una combinación de \'cursiva\', \'negrita\' y \'subrayado\'",
	...
	"vs/workbench/services/themes/electron-browser/colorThemeData": [
		...
		"Problema al analizar el archivo de tema de color: {0}. La propiedad \'tokenColors\' debe ser un array especificando colores o una ruta a un archivo de tema de TextMate",
	...
	"vs/workbench/services/themes/electron-browser/workbenchThemeService": [
		...
		"Establece los colores y estilos para números literales.",
