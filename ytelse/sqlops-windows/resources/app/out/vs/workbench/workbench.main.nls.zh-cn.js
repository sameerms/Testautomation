...
define("vs/workbench/workbench.main.nls.zh-cn", {
	...
	"vs/platform/theme/common/colorExtensionPoint": [
		...
		"高对比度主题的默认颜色。应为十六进制颜色值 (#RRGGBB[AA]) 或是主题颜色标识符，其提供默认值。",
		"\"configuration.colors\" 必须是数组",
		"{0} 必须为十六进制颜色值 (#RRGGBB[AA] 或 #RGB[A]) 或是主题颜色标识符，其提供默认值。",
		"必须定义 \"configuration.colors.id\"，且不能为空",
		"\"configuration.colors.id\" 必须满足 word[.word]*",
		"必须定义 \"configuration.colors.description\"，且不能为空",
		"必须定义 “configuration.colors.defaults”，且须包含 \"light\"(浅色)、\"dark\"(深色) 和 \"highContrast\"(高对比度)",
	],
	...
	"vs/workbench/common/theme": [
		...
		"用于高亮活动的选项卡的边框。选项卡是编辑器区域中编辑器的容器。可在一个编辑器组中打开多个选项卡。可以存在多个编辑器组。",
		"用于高亮一个失去焦点的编辑器组中的活动选项卡的边框。选项卡是编辑器区域中编辑器的容器。可在一个编辑器组中打开多个选项卡。可以存在多个编辑器组。",
		...
		"工作区打开时状态栏的前景色。状态栏显示在窗口底部。",
		"没有打开文件夹时状态栏的前景色。状态栏显示在窗口底部。",
		"工作区打开时状态栏的背景色。状态栏显示在窗口底部。",
		...
		"侧边栏中的部分在拖放时的反馈颜色。此颜色应有透明度，以便侧边栏中的部分仍能透过。侧边栏是资源管理器和搜索等视图的容器。",
	...
	"vs/workbench/parts/files/browser/files.contribution": [
		...
		"按名称的字母顺序排列文件和文件夹。文件夹显示在文件前。",
		"按名称的字母顺序排列文件和文件夹。两者穿插显示。",
		"按名称的字母顺序排列文件和文件夹。文件显示在文件夹前。",
		"按扩展名的字母顺序排列文件和文件夹。文件夹显示在文件前。",
	...
	"vs/workbench/parts/tasks/node/taskConfiguration": [
		...
		"错误: 没有注册任务类型“{0}”。你是不是忘记安装含有相应任务提供器的扩展?",
	...
	"vs/workbench/services/configuration/node/configuration": [
		...
		"配置属性的描述。",
		"特定于窗口的配置，可在“用户”或“工作区”设置中配置。",
		"特定于资源的配置，可在“用户”、“工作区”或“文件夹”设置中配置。",
		"配置适用的范围。可用范围有“窗口”和“资源”。",
		"如果进行设置，\"configuration.type\" 必须设置为对象",
		"configuration.title 必须是字符串",
		"按语言提供默认编辑器配置设置。",
		"configuration.properties 必须是对象",
		"要在工作区中加载的文件夹列表。必须为文件夹完整路径。例如 \"/root/folderA\" 或 \"./folderA\"。后者表示根据工作区文件位置进行解析的相对路径。",
	...
	"vs/workbench/services/themes/common/colorThemeSchema": [
		...
		"字体样式必须为 \"italic\"(斜体)、 \"bold\"(粗体)和 \"underline\"(下划线)的组合。",
		"规则的描述。",
		"此规则适用的范围选择器。",
