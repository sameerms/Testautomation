...
define("vs/workbench/workbench.main.nls.ko", {
	...
	"vs/platform/theme/common/colorExtensionPoint": [
		...
		"테마 지정 가능 색의 식별자입니다.",
		"식별자는 aa[.bb]* 형식이어야 합니다.",
		"테마 지정 가능 색에 대한 설명입니다.",
		"밝은 테마의 기본 색입니다. 16진수의 색 값(#RRGGBB[AA]) 또는 기본값을 제공하는 테마 지정 가능 색의 식별자입니다.",
		"어두운 테마의 기본 색입니다. 16진수의 색 값(#RRGGBB[AA]) 또는 기본값을 제공하는 테마 지정 가능 색의 식별자입니다.",
		"고대비 테마의 기본 색상입니다. 기본값을 제공하는 16진수(#RRGGBB[AA])의 색상 값 또는 테마 지정 가능 색의 식별자입니다.",
		"\'configuration.colors\'는 배열이어야 합니다.",
		"{0}은(는) 16진수의 색 값(#RRGGBB[AA] 또는 #RGB[A]) 또는 기본값을 제공하는 테마 지정 가능 색의 식별자입니다.",
		"\'configuration.colors.id\'를 정의해야 하여 비워 둘 수 없습니다.",
		"\'configuration.colors.id\'는 단어[.word]* 다음에 와야 합니다.",
		"\'configuration.colors.description\'를 정의해야 하며 비워 둘 수 없습니다.",
		"\'configuration.colors.defaults\'를 정의해야 하며 \'light\', \'dark\' 및 \'highContrast\'를 포함해야 합니다.",
	],
	...
	"vs/workbench/common/theme": [
		...
		"활성 탭을 강조 표시하기 위한 테두리입니다. 탭은 편집기 영역에서 편집기의 컨테이너입니다. 한 편집기 그룹에 여러 탭을 열 수 있습니다. 여러 편집기 그룹이 있을 수 있습니다.",
		"포커스가 없는 그룹에서 활성 탭을 강조 표시하기 위한 테두리입니다. 탭은 편집기 영역에서 편집기의 컨테이너입니다. 한 편집기 그룹에 여러 탭을 열 수 있습니다. 여러 편집기 그룹이 있을 수 있습니다.",
		...
		"작업 영역이 열려 있을 때의 상태 표시줄 전경색입니다. 상태 표시줄은 창의 맨 아래에 표시됩니다.",
		"폴더가 열리지 않았을 때의 상태 표시줄 전경색입니다. 상태 표시줄은 창의 맨 아래에 표시됩니다.",
		"작업 영역이 열려 있을 때의 상태 표시줄 배경색입니다. 상태 표시줄은 창의 맨 아래에 표시됩니다.",
		...
		"사이드 막대 섹션의 끌어서 놓기 피드백 색입니다. 사이드 막대 섹션이 계속 비추어 보이도록 이 색은 투명해야 합니다. 사이드 막대는 왼쪽이나 오른쪽 끝에 표시되며 사이드바의 보기를 전환할 수 있습니다.",
		...
		"제목 막대 테두리 색입니다. 현재 이 색상은 macOS에서만 지원됩니다.",
	...
	"vs/workbench/electron-browser/actions": [
		...
		"작업 영역",
		"파일",
		"선택하여 열기(새 창에서 열려면 Cmd 키를 길게 누름)",
		"선택하여 열기(새 창에서 열려면 Ctrl 키를 길게 누름)",
		"최근에 사용한 항목에서 제거",
		"최근 항목 열기...",
		"빠른 최근 항목 열기...",
		"알림 메시지 닫기",
	...
	"vs/workbench/electron-browser/main.contribution": [
		...
		"모든 창을 다시 엽니다.",
		"모든 폴더를 다시 엽니다. 빈 작업 영역은 복원되지 않습니다.",
		"마지막 활성 창을 다시 엽니다.",
		"창을 다시 열지 않고 항상 빈 창으로 시작합니다.",
		"다시 시작한 이후에 창을 다시 여는 방법을 설정합니다. \'none\'을 선택하면 항상 빈 작업 영역으로 시작하고 \'one\'을 선택하면 마지막으로 작업한 창이 다시 열리고 \'folders\'를 선택하면 열었던 폴더가 포함된 모든 창이 다시 열리며 \'all\'을 선택하면 지난 세션의 모든 창이 다시 열립니다.",
	...
	"vs/workbench/parts/files/browser/fileActions.contribution": [
		"파일",
		"세로 막대에 표시",
		"변경을 적용하고 디스크 콘텐츠 덮어쓰기",
		"변경 내용을 취소하고 디스크의 콘텐츠로 되돌리기",
	],
	...
	"vs/workbench/parts/files/browser/files.contribution": [
		...
		"파일 및 폴더가 이름을 기준으로 사전순으로 정렬됩니다. 폴더가 파일 앞에 표시됩니다.",
		"파일 및 폴더가 이름을 기준으로 사전순으로 정렬됩니다. 파일이 폴더와 결합됩니다.",
		"파일 및 폴더가 이름을 기준으로 사전순으로 정렬됩니다. 파일이 폴더 앞에 표시됩니다.",
		"파일 및 폴더가 확장명을 기준으로 사전순으로 정렬됩니다. 폴더가 파일 앞에 표시됩니다.",
		"파일 및 폴더가 마지막으로 수정한 날짜를 기준으로 내림차순 정렬됩니다. 폴더가 파일 앞에 표시됩니다.",
		"탐색기에서 파일 및 폴더의 정렬 순서를 제어합니다. 기본 정렬 외에 순서를 \'mixed\'(파일 및 폴더가 결합되어 정렬), \'type\'(파일 형식 기준), \'modified\'(마지막으로 수정한 날짜 기준) 또는 \'filesFirst\'(파일을 폴더 앞에 정렬)로 설정할 수 있습니다.",
	],
	"vs/workbench/parts/files/browser/saveErrorHandler": [
		...
		"오른쪽 편집기 도구 모음의 작업을 사용하여 변경 내용을 **실행 취소**하거나 디스크의 콘텐츠를 변경 내용으로 **덮어쓰기**",
	],
	...
	"vs/workbench/parts/preferences/browser/preferencesRenderers": [
		"설정을 여기에 넣어서 기본 설정을 덮어씁니다.",
		"설정에 쓸 수 없습니다. 파일에서 오류/경고를 해결하고 다시 시도하세요.",
		"설정을 여기에 넣어서 사용자 설정을 덮어씁니다.",
		"폴더 설정을 여기에 넣어서 작업 영역 설정을 덮어씁니다.",
		"기본 폴더 설정",
		"기본 설정",
		"설정을 찾을 수 없습니다.",
		"편집",
		...
		"이 설정은 사용자 설정이어야 합니다.",
		"이 설정은 지금 적용할 수 없으며 이 폴더를 직접 열 경우에 적용됩니다.",
	],
	...
	"vs/workbench/parts/relauncher/electron-browser/relauncher.contribution": [
		...
		"다시 시작",
		"이 작업 영역을 변경하려면 확장 시스템을 다시 로드해야 합니다.",
		"다시 로드",
	],
	...
	"vs/workbench/parts/search/browser/searchViewlet": [
		...
		"\'{0}\'에 결과 없음 - ",
		"\'{0}\'을(를) 제외하는 결과가 없음 - ",
		"결과가 없습니다. 구성된 예외 설정을 검토하고 파일을 무시하세요.",
		"다시 검색",
		"모든 파일에서 다시 검색",
		"설정 열기",
		"자세한 정보",
	...
	"vs/workbench/parts/tasks/electron-browser/jsonSchema_v2": [
		...
		"문제 선택기가 작업과 연결되어 있지 않고 실행하는 중 오류가 발생하는 경우에만 터미널을 표시합니다.",
	...
	"vs/workbench/parts/tasks/electron-browser/task.contribution": [
		...
		"\'{0}\' 작업이 이미 활성 상태로 백그라운드 모드에 있습니다. 종료하려면 작업 메뉴에서 \'작업 종료\'를 사용하세요.",
		"\'{0}\' 작업이 이미 활성 상태입니다. 작업을 종료하려면 작업 메뉴에서 \'작업 종료\'를 사용하세요.",
	...
	"vs/workbench/parts/tasks/node/taskConfiguration": [
		...
		"오류: 등록된 작업 형식 \'{0}\'이(가) 없습니다. 해당하는 작업 공급자를 제공하는 확장을 설치하지 않으셨습니까?",
		...
		"작업 버전 2.0.0은 글로벌 OS별 작업을 지원하지 않습니다. OS별 명령을 사용하여 작업으로 변환하세요. 영향을 받는 작업::\n{0}",
	],
	...
	"vs/workbench/parts/terminal/electron-browser/terminal.contribution": [
		...
		"터미널이 Windows에서 사용하는 셸의 경로입니다. Windows와 함께 제공되는 셸을 사용하는 경우(cmd, PowerShell 또는 Ubuntu의 Bash)",
		...
		"OS X의 터미널이 사용하는 VS Code 프로세스에 추가될 환경 변수를 포함한 개체",
		"Linux의 터미널에서 사용할 VS Code 프로세스에 추가되는 환경 변수를 포함한 개체",
		"Windows의 터미널에서 사용할 VS Code 프로세스에 추가되는 환경 변수를 포함한 개체",
		"터미널",
		"터미널",
		"보기",
	],
	...
	"vs/workbench/parts/update/electron-browser/update": [
		...
		"지금 다운로드",
		"다시 표시 안 함",
		"64비트 Windows용 {0}을(를) 지금 사용할 수 있습니다.",
		"자세한 정보",
	...
	"vs/workbench/services/configuration/node/configuration": [
		...
		"구성 속성에 대한 설명입니다.",
		"[사용자] 설정 또는 [작업 영역] 설정에서 구성할 수 있는 창 특정 구성입니다.",
		"사용자, 작업 영역 또는 폴더 설정에서 구성할 수 있는 리소스 특정 구성",
		"구성이 적용되는 범위입니다. 사용 가능 범위는 \'창\'과 \'리소스\'입니다.",
		...
		"작업 영역에 로드할 폴더 목록입니다. 파일 경로를 사용해야 합니다. 예: `/root/folderA` 또는 `./folderA`(작업 영역 파일의 위치를 기준으로 확인할 상대 경로인 경우)",
	...
	"vs/workbench/services/configuration/node/jsonEditingService": [
		...
		"파일이 오염되어 파일에 쓸 수 없습니다. 파일을 저장하고 다시 시도하세요.",
	],
	...
	"vs/workbench/services/themes/common/colorThemeSchema": [
		...
		"글꼴 스타일은 \'기울임꼴, \'굵게\' 및 \'밑줄\'의 조합이어야 합니다.",
		"규칙에 대한 설명입니다.",
