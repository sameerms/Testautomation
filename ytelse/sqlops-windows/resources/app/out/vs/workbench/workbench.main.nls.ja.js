...
define("vs/workbench/workbench.main.nls.ja", {
	...
	"vs/platform/theme/common/colorExtensionPoint": [
		...
		"high contrast テーマの既定の配色。配色の値は 16 進数(#RRGGBB[AA]) 、または 既定で提供されているテーマ設定可能な配色の識別子の既定値のいずれか。",
		"\'configuration.colors\' は配列である必要があります",
		"{0} は 16 進数(#RRGGBB[AA] または  #RGB[A]) 、または 既定で提供されているテーマ設定可能な配色の識別子の既定値のいずれかでなければなりません。",
		"\'configuration.colors.id\' は定義する必要があり、空にできません",
		"\'configuration.colors.id\' は word[.word]* の形式である必要があります",
		"\'configuration.colors.description\' は定義する必要があり、空にできません \n",
		"\'configuration.colors.defaults\' は定義する必要があります。\'light\' か \'dark\'、\'highContrast\' を含める必要があります。",
	],
	...
	"vs/workbench/common/theme": [
		...
		"フォーカスされていないグループ内のアクティブ タブを強調表示するための境界線。タブはエディター領域内にあるエディターのコンテナーです。複数のタブを 1 つのエディター グループで開くことができます。複数のエディター グループがある可能性があります。",
		...
		"ワークスペースを開いていないときのステータス バーの前景色。ステータス バーはウィンドウの下部に表示されます。",
		"フォルダーが開いていないときのステータス バーの前景色。ステータス バーはウィンドウの下部に表示されます。",
		"ワークスペースを開いていないときのステータス バーの背景色。ステータス バーはウィンドウの下部に表示されます。",
	...
	"vs/workbench/parts/files/browser/files.contribution": [
		...
		"ファイルとフォルダーをアルファベット順に名前で並び替えます。フォルダーはファイルの前に表示されます。",
		"ファイルとフォルダーをアルファベット順に名前で並び替えます。ファイルはフォルダーと混交して表示されます。",
		"ファイルとフォルダーをアルファベット順に名前で並び替えます。ファイルはフォルダーの前に表示されます。",
		"ファイルとフォルダーをアルファベット順に拡張子で並び替えます。フォルダーはファイルの前に表示されます。",
		"ファイルとフォルダーを降順に最終更新日で並び替えます。フォルダーはファイルの前に表示されます。",
		"エクスプローラー内のファイルとフォルダーの並び順を制御します。既定の並び順に加えて、\'mixed\' (ファイルとフォルダーを混交した並び順)、\' type\' (ファイルの種類順)、\' modified\' (最終更新日時順)、または \'filesFirst\' (フォルダーの前にファイルを並べる) のいずれかの並び順に設定できます。 ",
	],
	...
	"vs/workbench/parts/preferences/browser/preferencesRenderers": [
		...
		"ユーザー設定を上書きするには、このファイル内に設定を挿入します。",
		...
		"この設定は現在適用できません。このフォルダーを直接開いたときに適用されます。",
	],
	...
	"vs/workbench/parts/search/browser/searchViewlet": [
		...
		"\'{0}\' に結果はありません - ",
		"\'{0}\' を除外した結果はありませんでした - ",
		"結果はありません。構成された除外と無視するファイルの設定を確認してください -",
		"もう一度検索してください",
	...
	"vs/workbench/parts/tasks/electron-browser/jsonSchema_v2": [
		...
		"タスクに関連付けられた問題マッチャーがなく、実行時にエラーが発生した場合のみターミナルを表示します。",
	...
	"vs/workbench/parts/tasks/electron-browser/task.contribution": [
		...
		"実行中のタスクを表示",
		"タスク",
		"タスクの実行エンジンを変更するにはウィンドウの再読み込みが必要です",
	...
	"vs/workbench/parts/tasks/node/taskConfiguration": [
		...
		"Error: タスク タイプ \'{0}\' は登録されていません。対応するタスク プロバイダーを提供する拡張機能をインストールしましたか?",
	...
	"vs/workbench/parts/update/electron-browser/update": [
		...
		"今すぐダウンロード",
		"今後は表示しない",
		"64 ビット Windows 用の {0} が利用可能になりました！",
		"詳細情報",
		"新しい更新 {0} が利用可能です。",
		"利用可能な更新プログラムがあります。",
		"{0} は再起動後に更新されます。",
	...
	"vs/workbench/services/configuration/node/configuration": [
		...
		"構成のプロパティの説明です。",
		"ウィンドウ固有の構成。ユーザーまたはワークスペースの設定で構成できます。",
		"リソース固有の構成。ユーザー、ワークスペース、またはフォルダーの設定で構成できます。",
		"構成が適用される範囲。 使用可能なスコープは `window` と ` resource` です。",
		...
		"ワークスペースで読み込まれるフォルダーのリスト。ファイル パスである必要があります。例: `/root/folderA` または `./folderA` のようなワークスペース ファイルの場所に対して解決される相対パス。",
	...
	"vs/workbench/services/extensions/electron-browser/extensionService": [
		"開発者ツール",
		"拡張機能のホストを再起動",
		"拡張機能のホストが予期せずに終了しました。",
		"拡張機能のホストが応答しないため終了しました。",
	...
	"vs/workbench/services/themes/common/colorThemeSchema": [
		...
		"フォント スタイルは \'斜体\'、\'太字\'、\'下線\'を組み合わせる必要があります。",
		"ルールの説明。",
