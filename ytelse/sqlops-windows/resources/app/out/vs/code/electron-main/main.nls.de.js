...
define("vs/code/electron-main/main.nls.de", {
	"vs/code/electron-main/auth": [
		...
		"Der Proxy {0} erfordert eine Authentifizierung.",
	],
	...
	"vs/code/electron-main/windows": [
		...
		"&&Nicht speichern",
		"Abbrechen",
		"Möchten Sie Ihre Arbeitsbereichskonfiguration als Datei speichern?",
		"Speichern Sie Ihren Arbeitsbereich, wenn Sie ihn erneut öffnen möchten.",
		"&&Speichern",
