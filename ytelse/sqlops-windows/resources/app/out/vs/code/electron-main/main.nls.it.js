...
define("vs/code/electron-main/main.nls.it", {
	"vs/code/electron-main/auth": [
		...
		"Il proxy {0} richiede l\'autenticazione.",
	],
	...
	"vs/code/electron-main/windows": [
		...
		"&&Non salvare",
		"Annulla",
		"Salvare la configurazione dell\'area di lavoro in un file?",
		"Salvare l\'area di lavoro se si prevede di aprirla di nuovo.",
		"&&Salva",
