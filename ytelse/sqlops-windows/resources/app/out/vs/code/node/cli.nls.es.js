...
define("vs/code/node/cli.nls.es", {
	"vs/platform/environment/node/argv": [
		...
		"Comparar dos archivos entre sí.",
		"Agregar carpetas a la última ventana activa.",
		"Abrir un archivo en la ruta de acceso de la línea y posición de carácter especificadas.",
