 ...
 *--------------------------------------------------------*/
(function() {
var __m = ["exports","require","vs/base/common/uri","path","vs/platform/node/product","vs/nls!vs/platform/environment/node/argv","vs/base/common/winjs.base","vs/base/common/platform","vs/base/common/types","vs/platform/node/package","vs/base/common/objects","vs/base/common/arrays","vs/platform/environment/node/argv","os","vs/base/common/winjs.base.raw","fs","vs/nls","minimist","assert","vs/code/node/cli","child_process","vs/nls!vs/code/node/cli"];
...
define(__m[6/*vs/base/common/winjs.base*/], __M([14/*vs/base/common/winjs.base.raw*/]), function (winjs) {
	'use strict';
	return {
...
define(__m[5/*vs/nls!vs/platform/environment/node/argv*/], __M([16/*vs/nls*/,21/*vs/nls!vs/code/node/cli*/]), function(nls, data) { return nls.create("vs/platform/environment/node/argv", data); });
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the Source EULA. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[9/*vs/platform/node/package*/], __M([1/*require*/,0/*exports*/,3/*path*/,2/*vs/base/common/uri*/]), function (require, exports, path, uri_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the Source EULA. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[4/*vs/platform/node/product*/], __M([1/*require*/,0/*exports*/,3/*path*/,2/*vs/base/common/uri*/]), function (require, exports, path, uri_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var rootPath = path.dirname(uri_1.default.parse(require.toUrl('')).fsPath);
 ...
 *  Licensed under the Source EULA. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[12/*vs/platform/environment/node/argv*/], __M([1/*require*/,0/*exports*/,13/*os*/,17/*minimist*/,18/*assert*/,11/*vs/base/common/arrays*/,5/*vs/nls!vs/platform/environment/node/argv*/,4/*vs/platform/node/product*/]), function (require, exports, os, minimist, assert, arrays_1, nls_1, product_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var options = {
        string: [
    ...
    exports.optionsHelp = {
        ...
        '--locale <locale>': nls_1.localize(4, null),
        '-n, --new-window': nls_1.localize(5, null),
        '-p, --performance': nls_1.localize(6, null),
        '--prof-startup': nls_1.localize(7, null),
        '-r, --reuse-window': nls_1.localize(8, null),
        '--user-data-dir <dir>': nls_1.localize(9, null),
        '--verbose': nls_1.localize(10, null),
        '-w, --wait': nls_1.localize(11, null),
        ...
        '--uninstall-extension <extension-id>': nls_1.localize(16, null),
        '--enable-proposed-api <extension-id>': nls_1.localize(17, null),
        '--disable-extensions': nls_1.localize(18, null),
        '--disable-gpu': nls_1.localize(19, null),
        '-v, --version': nls_1.localize(20, null),
        '-h, --help': nls_1.localize(21, null)
    };
    // TODO@Ben multi root
    ...
    function buildHelpMessage(fullName, name, version) {
        ...
        return fullName + " " + version + "\n\n" + nls_1.localize(22, null) + ": " + executable + " [" + nls_1.localize(23, null) + "] [" + nls_1.localize(24, null) + "...]\n\n" + nls_1.localize(25, null) + ":\n" + formatOptions(exports.optionsHelp, columns);
    }
 ...
 *  Licensed under the Source EULA. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[19/*vs/code/node/cli*/], __M([1/*require*/,0/*exports*/,20/*child_process*/,6/*vs/base/common/winjs.base*/,10/*vs/base/common/objects*/,12/*vs/platform/environment/node/argv*/,4/*vs/platform/node/product*/,9/*vs/platform/node/package*/,15/*fs*/,3/*path*/,13/*os*/]), function (require, exports, child_process_1, winjs_base_1, objects_1, argv_1, product_1, package_1, fs, paths, os) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
