...
var ls = require('dataprotocol-languageserver-types');
...
function createConverter(uriConverter) {
    ...
    function asCompletionItem(item) {
        ...
        set(item.insertText, function () { return result.insertText = String(item.insertText); });
    ...
    function asCapabilitiesParams(client) {
        var params = {
    ...
    function asConnectionParams(connUri, connInfo) {
        return {
            ownerUri: connUri,
            connection: {
    ...
    function asMetadataQueryParams(connectionUri) {
        return {
            ownerUri: connectionUri
        };
    }
    function asListDatabasesParams(connectionUri) {
        return {
            ownerUri: connectionUri
        };
    }
    function asTableMetadataParams(connectionUri, metadata) {
        return {
            ownerUri: connectionUri,
    ...
    function asScriptingParams(connectionUri, operation, metadata, paramDetails) {
        var scriptingObject = {
            type: metadata.metadataTypeName,
            schema: metadata.schema,
            name: metadata.name
        };
        var targetDatabaseEngineEdition = paramDetails.targetDatabaseEngineEdition;
        var targetDatabaseEngineType = paramDetails.targetDatabaseEngineType;
        var scriptCompatibilityOption = paramDetails.scriptCompatibilityOption;
        var options = {
    ...
    function asConnectionDetail(connInfo) {
        return {
            options: connInfo.options
        };
    }
    function asExpandInfo(nodeInfo) {
        return {
            sessionId: nodeInfo.sessionId,
            nodePath: nodeInfo.nodePath
        };
    }
    function asCloseSessionInfo(nodeInfo) {
        return {
            sessionId: nodeInfo.sessionId
        };
    }
    ...
    function asListTasksParams(params) {
        return {
            listActiveTasksOnly: params.listActiveTasksOnly
        };
    }
    function asCancelTaskParams(params) {
        return {
            taskId: params.taskId
        };
    }
    function asRestoreParams(ownerUri, params) {
        return {
            ownerUri: ownerUri,
    ...
    function asRestoreConfigInfoParams(ownerUri) {
        return {
            ownerUri: ownerUri
        };
    }
    return {
        ...
        asCapabilitiesParams: asCapabilitiesParams,
        asConnectionParams: asConnectionParams,
        asMetadataQueryParams: asMetadataQueryParams,
        asTableMetadataParams: asTableMetadataParams,
        asListDatabasesParams: asListDatabasesParams,
        asScriptingParams: asScriptingParams,
        asConnectionDetail: asConnectionDetail,
        asExpandInfo: asExpandInfo,
        asCloseSessionInfo: asCloseSessionInfo,
        asExecutionPlanOptions: asExecutionPlanOptions,
        asListTasksParams: asListTasksParams,
        asCancelTaskParams: asCancelTaskParams,
        asRestoreParams: asRestoreParams,
        asRestoreConfigInfoParams: asRestoreConfigInfoParams
    };
}
