...
import { Message, RequestHandler, NotificationHandler, ErrorCodes, ResponseError, RequestType, NotificationType, Trace, Event } from 'dataprotocol-jsonrpc';
import { Range, Position, Location, TextEdit, WorkspaceChange, TextEditChange, TextDocumentIdentifier } from 'dataprotocol-languageserver-types';
...
export declare class LanguageClient {
     ...
     * @param handler
     */
    private onConnectionReadyNotification<P>(type, handler);
    private hookDataProtocolProvider(providerId);
